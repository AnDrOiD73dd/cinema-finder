...
@Singleton
public final class GetTopRatingsUseCase {

    private final MoviesRepository moviesRepository;

    @Inject
    GetTopRatingsUseCase(final MoviesRepository moviesRepository) {
    ...
    public Single<List<MovieListModel>> execute(final String page, final Language language,
        ...
        return moviesRepository.getTopRatingMovies(page, language, region, logoSize);
    }
}
