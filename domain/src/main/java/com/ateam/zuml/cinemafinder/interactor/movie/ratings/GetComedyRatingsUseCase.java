...
@Singleton
public final class GetComedyRatingsUseCase {

    private final MoviesRepository moviesRepository;

    @Inject
    GetComedyRatingsUseCase(final MoviesRepository moviesRepository) {
    ...
    public Single<List<MovieListModel>> execute(final String page, final Language language,
        ...
        return moviesRepository.getComedyRatingMovies(page, language, region, logoSize);
    }
}
